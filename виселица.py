...
Суть игры: 
Втайне от пользователя компьютер 
выбирает какое-либо слово, 
и игрок должен попробовать отгадать его,
высказывая свои предположения побуквенно. 
Каждый раз, когда игрок ошибается,
компьютер дорисовывает
на экране изображение фигурки под виселицей. 
Если в отведенное количество попыток игроку 
не удается отгадать слово, то “повешенный” гибнет.'''
